...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex flex-col lg:flex-row gap-3 p-3 pt-2 pb-4 overflow-hidden">
        <aside className="w-full lg:w-72 xl:w-80 flex-shrink-0 order-2 lg:order-1 stagger-in stagger-1">
          <AssetLibrary />
        </aside>

        <main className="flex-1 flex flex-col gap-3 order-1 lg:order-2 min-h-0 overflow-hidden stagger-in stagger-2">
        ...
        <aside className="w-full lg:w-72 xl:w-80 flex-shrink-0 space-y-3 order-3 stagger-in stagger-3">
          <ColorPanel />
          <PropertyPanel />
        </aside>
      </div>
